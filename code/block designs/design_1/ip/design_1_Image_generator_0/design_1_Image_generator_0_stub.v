...
//               designs/design_1/ip/design_1_Image_generator_0/design_1_Image_generator_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "design_1_Image_generator_0,Image_generator,{}" *) (* CORE_GENERATION_INFO = "design_1_Image_generator_0,Image_generator,{x_ipProduct=Vivado 2024.2.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=Image_generator,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,H_VISIBLE=640,H_FRONT=16,H_PULSE=64,H_BACK=120,V_VISIBLE=480,V_FRONT=1,V_PULSE=3,V_BACK=16}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "Image_generator,Vivado 2024.2.1" *) 
module design_1_Image_generator_0(CLK, RESETN, RED, GREEN, BLUE, DE, HSYNC, VSYNC)
